...
[Explore Interactive Map →](interactive.qmd){.btn .btn-primary}
...
**Interpretation:**
- 100% shade segment → 30% cost reduction
- 0% shade segment → No discount
...
[**Try it now →**](interactive.qmd){.btn .btn-primary}
...
| **Temporal Modeling** | 8 scenarios (season × time) | Single snapshot or none |
...
- ✅ 99.7% LiDAR building coverage
- ✅ Raster-based efficiency (3-foot resolution)
...
::: {.g-col-4}
**🗺️ [Interactive Map](interactive.qmd)**
...
::: {.g-col-6}
**📚 [Technical Appendix](appendix.qmd)**
...
**Built with 🌳 for heat-resilient cities**
